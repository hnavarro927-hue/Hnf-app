...
const staticFiles = new Map([
  ...
  ['/services/approval.service.js', 'services/approval.service.js'],
  ['/services/client.service.js', 'services/client.service.js'],
  ['/services/clima.service.js', 'services/clima.service.js'],
  ['/services/expense.service.js', 'services/expense.service.js'],
  ['/services/flota.service.js', 'services/flota.service.js'],
  ['/services/gestion.service.js', 'services/gestion.service.js'],
  ['/services/health.service.js', 'services/health.service.js'],
  ['/services/matriz.service.js', 'services/matriz.service.js'],
  ['/services/message.service.js', 'services/message.service.js'],
  ['/services/http-client.js', 'services/http-client.js'],
  ['/services/ot.service.js', 'services/ot.service.js'],
  ['/services/tecnico.service.js', 'services/tecnico.service.js'],
  ...
  ['/views/gerencia.js', 'views/gerencia.js'],
  ['/views/flota.js', 'views/flota.js'],
  ['/views/home.js', 'views/home.js'],
  ['/views/operaciones.js', 'views/operaciones.js'],
  ['/services/log.service.js', 'services/log.service.js'],
  ['/views/inbox.js', 'views/inbox.js'],
  ['/views/approval-lyn.js', 'views/approval-lyn.js'],
  ['/views/manager.js', 'views/manager.js'],
]);
